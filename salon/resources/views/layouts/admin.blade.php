    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake"
                src="{{ asset('assets/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="60" width="60">
        </div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('assets/dist/img/user4-128x128.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ url ('transaction') }}" class="nav-link {{ request()->is('transaction') ? 'active' : '' }}">
                                <i class="fa-sharp fa-light fa-user fa-fw"></i>
                                <p>
                                    Transaction
                                </p>
                            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023 <a href="https://coilflow.id">Coilflow</a>.</strong>
            All rights reserved.
